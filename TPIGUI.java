...
public class TPIGUI extends JFrame implements ActionListener
{
    ...
    public void createHomePage()
    {
		        ...
		        infoText = new TextArea("", 4, 30, TextArea.SCROLLBARS_VERTICAL_ONLY);         
                homePanel.add(infoLabel);
                homePanel.add(infoText);           
    ...
    public void createSystemSetupPage()
    {
		...
		systemSetupPanel.add( minCellField );
                ...
                systemSetupPanel.add(minField);
                systemSetupPanel.add(hourLabel);
                systemSetupPanel.add(hourField);
                ...
                systemSetupPanel.add(prMinField);
                systemSetupPanel.add(prMinLabel);
                systemSetupPanel.add(prSecField);
                systemSetupPanel.add(prSecLabel);
	...
	public void createCheckSettingsPage()
	{
		//panelIndex = 2;
                ...
                checkSettingsPanel.add(battVoltLabel);
                checkSettingsPanel.add(battVoltField);
                ...
                checkRefreshButton = new CustomButton("Refresh","Reset the Activity Log");
	...
	public void createConfirmPage()
	{
		...
		confirmPanel.add( minCellStatus );
                ...
                conRefreshButton = new CustomButton("Update Threshold","Update threshold values");
                    ...
                    (otherNumRadioButton.isSelected() && cellField.getText().isEmpty()))
            {
                        ...
                        ((otherNumRadioButton.isSelected()) && (Integer.parseInt(cellField.getText())) < 1))
                {
                    ...
                    JOptionPane.showMessageDialog( tabbedPane,
                        ...
                        || (minTotalField.getText().startsWith("-")))
                {
                    ...
                    JOptionPane.showMessageDialog( tabbedPane,
                        ...
                        || (minCellField.getText().startsWith("-")))
                {
                    ...
                    JOptionPane.showMessageDialog( tabbedPane,
                        "Please enter a valid Cell Alarm Value");
                         ...
                         (hourField.getText().startsWith("-"))  ||
                         (minField.getText().startsWith("-"))  ||
                         (Integer.parseInt(minField.getText()) > 59 ))
                {
                    ...
                    JOptionPane.showMessageDialog( tabbedPane,
                        "Please enter a valid Target Time Value");
                         ...
                         (prMinField.getText().startsWith("-"))  ||
                         (prSecField.getText().startsWith("-"))  ||
                         (Integer.parseInt(prSecField.getText()) > 59 ))
                {
